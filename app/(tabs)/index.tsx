...
import { currentUser, activities, achievements, teams, trainingPlans } from '../../data/mockData';
...
export default function HomeScreen() {
  ...
  const handleStartActivity = () => {
    if (isWeb) {
      alert('El registro de actividad con GPS solo está disponible en la app móvil.');
    } else {
  ...
  return (
    <ScrollView style={isWeb ? styles.scrollWeb : undefined} contentContainerStyle={isWeb ? styles.scrollContentWeb : undefined}>
      {isWeb ? (
        <View style={styles.webContainer}>
          ...
          <View style={styles.webGrid}>
            <View style={styles.webMain}>
              ...
              <Card title="Planes de Entrenamiento" rightContent={
                <Button title="Crear Plan" onPress={() => {}} variant="secondary" style={{ paddingVertical: 6, paddingHorizontal: 12 }} />
              }>
